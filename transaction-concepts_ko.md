...
![Example BigchainDB CREATE transaction](https://github.com/KWOpenSource/bigchaindb/blob/m_branch/docs/root/source/transaction-concepts_ko.md/_static/CREATE_example.png)
